        ...
        if self.type == 'player' or self.type == 'enemy':
            ...
            if self.chosenpokemon is None or self.active is False:
                return {
                    ...
                    "Type": temptype,
                    "Attack": round(self.battleATK,0),
                    "Defense": round(self.battleDEF,0),
                    "Special Attack": round(self.battleSpATK,0),
                    "Special Defense": round(self.battleSpDEF,0),
                    "Speed": round(self.battleSpeed,0),
                    "Height": self.height,
                    "Weight": self.weight
                }
            else:
